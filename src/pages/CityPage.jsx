...
const s = {
  ...
  tag: { display: 'inline-block', fontFamily: "'DM Sans', sans-serif", fontSize: '10px', fontWeight: '500', textTransform: 'uppercase', color: '#9B9590', border: '1px solid #D8D4CE', padding: '4px 10px', borderRadius: '2px', letterSpacing: '0.1em', lineHeight: '1.4' },
  instagramTag: { display: 'inline-block', fontFamily: "'DM Sans', sans-serif", fontSize: '10px', fontWeight: '500', textTransform: 'uppercase', color: '#B07D62', border: '1px solid #E8D5C4', backgroundColor: '#FDF8F5', padding: '4px 10px', borderRadius: '2px', letterSpacing: '0.1em', lineHeight: '1.4' },
  styleTag: { display: 'inline-block', fontFamily: "'DM Sans', sans-serif", fontSize: '10px', fontWeight: '500', textTransform: 'uppercase', color: '#B07D62', border: '1px solid #E8D5C4', backgroundColor: '#FDF8F5', padding: '4px 10px', borderRadius: '2px', letterSpacing: '0.1em', lineHeight: '1.4' },
